...
class DurationBaseTypeHandlerTest {
    ...
    @InjectMocks
    private DurationBaseTypeHandler instance;

    @Test
    public void testSetNonNullParameter() throws Exception {
        instance.setNonNullParameter(mockPreparedStatement, 1, EXPECTED_DURATION, JdbcType.VARCHAR);
    ...
    public void testGetNullableResult_String() throws Exception {
        ...
        Duration result = instance.getNullableResult(mockResultSet, COLUMN_NAME);
    ...
    public void testGetNullableResult_Int() throws Exception {
        ...
        Duration result = instance.getNullableResult(mockResultSet, columnId);
    ...
    public void testGetNullableResult_Callable_Statement() throws Exception {
        ...
        Duration result = instance.getNullableResult(mockCallableStatement, columnId);
