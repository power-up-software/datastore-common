...
class IntegerListTypeHandlerTest {
    private static final List<Integer> EXPECTED_LIST = new ArrayList<>();
    ...
    @InjectMocks
    private IntegerListTypeHandler instance;
    ...
    public void testGetResult_String() throws Exception {
        ...
        List<Integer> result = instance.getResult(mockResultSet, COLUMN_NAME);
    ...
    public void testGetResult_Int() throws Exception {
        ...
        List<Integer> result = instance.getResult(mockResultSet, columnId);
    ...
    public void testGetResult_Callable_Statement() throws Exception {
        ...
        List<Integer> result = instance.getResult(mockCallableStatement, columnId);
